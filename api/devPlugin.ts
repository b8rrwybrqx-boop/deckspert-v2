...
const routes: RouteDefinition[] = [
  ...
  { exact: "/api/creator-chat-debug", loadHandler: () => import("./creator-chat-debug") },
  ...
  { exact: "/api/platform-evaluator", loadHandler: () => import("./platform-evaluator") },
  { exact: "/api/platform-prep-evaluator", loadHandler: () => import("./platform-prep-evaluator") },
  { exact: "/api/platform-storyboard-evaluator", loadHandler: () => import("./platform-storyboard-evaluator") },
