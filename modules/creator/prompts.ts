...
export function buildCreatorGeneratePrompt(input: {
  ...
  return [
    ...
    "Use TPG section-level page discipline by default: Opening Gambit 1 slide, Desired Outcome 1, Situation 1-2, Root Cause 1 (2 only if clearly distinct drivers), Big Idea 1, How It Works 2-4, WIIFM 1-2, Close 1, Actions & Next Steps 1.",
    "Only How It Works should naturally expand. If another section needs more than its default constraint, treat that as a warning sign and compress unless the source materially justifies expansion.",
...
export function buildCreatorRevisePrompt(input: {
  ...
  return [
    ...
    "Preserve TPG section discipline: most sections should remain one slide, and only How It Works should naturally expand across multiple slides.",
